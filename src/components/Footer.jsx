...
export default function Footer() {
  ...
  // Each platform: brandBg = the real app background colour, icon = white
  const socialLinks = [
    {
      Icon: FacebookIcon,
      ...
      label: "Facebook",
      brandBg: "#1877F2",
      shadow: "rgba(24,119,242,0.55)",
    },
    {
      Icon: InstagramIcon,
      href: "https://www.instagram.com/scanforsafeinnovations?igsh=anhlN2t1eG9qNDV2",
      label: "Instagram",
      brandBg: "linear-gradient(45deg,#f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%)",
      shadow: "rgba(220,39,67,0.55)",
    },
    {
      Icon: TwitterXIcon,
  ...
  overflow: hidden;
      ...
      <footer className="sfs-footer">
        <div className="sfs-footer-overlay" />
          ...
          <div className="sfs-footer-main">
            ...
            <div className="sfs-footer-brand">
              <Link to="/" className="sfs-footer-logo-wrap" style={{ textDecoration: "none" }}>
                ...
                <div>
                  <h2 className="sfs-footer-title">Scan<span>ForSafe</span></h2>
                  <div className="sfs-footer-tagline">Smart Shield</div>
                </div>
              </Link>

              <p className="sfs-footer-desc">
                Pioneering secure QR code solutions, visual verification systems, and smart tracking technologies.
                Empowering a safer and more authentic world through trusted hardware and visual tags.
              </p>

              {/* ── APP-ICON SOCIAL BUTTONS ── */}
              <div className="sfs-footer-socials">
                {socialLinks.map(({ Icon, href, label, brandBg, shadow }) => (
                  <a
                    key={label}
                    href={href}
                    target="_blank"
            ...
            <div>
              ...
              <div className="sfs-footer-links">
                {navLinks.map((item, i) => (
                  ...
                  >
                    <span className="sfs-footer-link-dot" />
                    {item.label}
                  </Link>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="sfs-footer-contact-list">
                ...
                <div className="sfs-footer-contact-item">
                  ...
                  <div className="sfs-footer-contact-text">
                    <strong>Email</strong>customercare@scanforsafe.com
                  </div>
                </div>
                <div className="sfs-footer-contact-item">
          ...
          <div className="sfs-footer-bottom">
            ...
            <div className="sfs-footer-badges">
              <span className="sfs-footer-badge">
                <Lock size={14} className="sfs-footer-badge-icon" /> SSL Secured
              </span>
              <span className="sfs-footer-badge">
                <ShieldCheck size={14} className="sfs-footer-badge-icon" /> ISO 27001 Certified
              </span>
              <span className="sfs-footer-badge">
                <Leaf size={14} className="sfs-footer-badge-icon" /> Eco Friendly tags
              </span>
            </div>
          </div>
