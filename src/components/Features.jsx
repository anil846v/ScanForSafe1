...
const FEATURES = [
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" width="28" height="28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16 2C8.268 2 2 8.268 2 16c0 2.478.649 4.8 1.785 6.813L2 30l7.38-1.763A13.94 13.94 0 0 0 16 30c7.732 0 14-6.268 14-14S23.732 2 16 2z" fill="#25D366"/>
    ...
    accentDark: '#16a34a',
    dotColor: '#bbf7d0',
    cardBg: 'linear-gradient(145deg,#ffffff 55%,#f0fdf4 100%)',
    activeBg: 'linear-gradient(145deg,#f0fdf4 0%,#dcfce7 100%)',
    tag: 'Most Loved',
  ...
  },
  {
    ...
    accentDark: '#3730a3',
    dotColor: '#c7d2fe',
    cardBg: 'linear-gradient(145deg,#ffffff 55%,#eef2ff 100%)',
    activeBg: 'linear-gradient(145deg,#eef2ff 0%,#e0e7ff 100%)',
    tag: 'Zero Friction',
  ...
  },
  {
    ...
    accentDark: '#5b21b6',
    dotColor: '#ddd6fe',
    cardBg: 'linear-gradient(145deg,#ffffff 55%,#f5f3ff 100%)',
    activeBg: 'linear-gradient(145deg,#f5f3ff 0%,#ede9fe 100%)',
    tag: 'Family Ready',
  ...
  },
  {
    id: 'gps',
    icon: (
      <svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="#16a34a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <div style={{
            ...
            fontSize: 12, fontWeight: 600, color: '#16a34a', marginBottom: 18,
          }}>
          ...
          <h2 style={{
            ...
            Powerful Features for <span style={{ color: '#16a34a' }}>Peace of Mind</span>
          </h2>

          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 14 }}>
            <div style={{ width: 48, height: 1.5, background: 'linear-gradient(90deg,transparent,#16a34a)' }} />
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2.5">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
            </svg>
            <div style={{ width: 48, height: 1.5, background: 'linear-gradient(90deg,#16a34a,transparent)' }} />
          </div>

          <p style={{ fontSize: 14.5, color: '#475569', maxWidth: 480, margin: '0 auto', lineHeight: 1.75 }}>
            Everything you need to keep your loved ones safe — <strong style={{ color: '#1e293b', fontWeight: 600 }}>no app needed on the finder's end.</strong>
          </p>
        </div>
