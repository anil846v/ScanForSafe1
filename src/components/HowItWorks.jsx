...
function StepArrow({ color="#2ebd3a" }) {
  return (
    <div className="hiw-step-arrow" style={{
      display: "flex",
      alignItems: "center",
      ...
      <svg width="36" height="28" viewBox="0 0 36 28" fill="none">
        <line x1="2" y1="14" x2="26" y2="14" stroke={color} strokeWidth="2" strokeDasharray="4 3" strokeLinecap="round"/>
        <path d="M24 7 L33 14 L24 21" stroke={color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
      </svg>
    </div>
  );
}
...
export default function HowItWorks() {
  ...
  return (
    <div style={{ paddingTop:"80px", background:"linear-gradient(160deg,#f8fafc 0%,#fafcfa 50%,#f8fafc 100%)", fontFamily:"'DM Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ position:"relative", zIndex:1, maxWidth:1200, margin:"0 auto", padding:"48px 24px 44px" }}>
        ...
        <div className="hiw-row" style={{ display:"flex", alignItems:"stretch", gap:32 }}>
          ...
          <div ref={cardsColRef} className="hiw-left" style={{ flex:"1 1 0", minWidth:0, opacity:visible?1:0, transform:visible?"translateX(0)":"translateX(-24px)", transition:"all 0.6s ease 0.1s" }}>
            ...
            {/* Step cards */}
            <div className="hiw-steps-container" style={{ position:"relative", display:"flex", gap:12, flexWrap:"nowrap", alignItems:"stretch" }}>
              {steps.map((s, i) => (
                <StepCard key={i} {...s}/>
              ))}
            </div>
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Sora:wght@300;400;600;700;800;900&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,400&family=Caveat:wght@600;700&display=swap');
        ...
        @media (min-width: 641px) and (max-width: 1024px) {
          ...
          .hiw-left p { font-size: 16px !important; margin-bottom: 32px !important; }
          .hiw-step-card h3 { font-size: 17px !important; }
          .hiw-step-card p { font-size: 13.5px !important; line-height: 1.7 !important; }
          .hiw-step-card div { font-size: 12.5px !important; }
        }
        @media (max-width: 640px) {
          .hiw-left h1 { text-align: center !important; font-size: 28px !important; line-height: 1.2 !important; }
          .hiw-left p { text-align: center !important; margin-left: auto !important; margin-right: auto !important; margin-bottom: 24px !important; font-size: 13.5px !important; }
          .hiw-steps-container { flex-direction: column !important; gap: 16px !important; }
          .hiw-step-card { flex: none !important; width: 100% !important; min-width: 0 !important; }
        }
